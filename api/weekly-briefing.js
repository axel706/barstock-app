  ...
  try {
    ...
    if (body.mode === 'order-analysis') {
      ...
      const prompt = body.orderPrompt + '\n\nHOW TO WRITE THIS:\n' +
        ...
        'The manager already knows the individual product suggestions and decided to keep the order as-is. Your job is to look at the order as a whole and find meaningful savings — be conservative but not timid. Scale your adjustments to the order size: on a $400+ order, $15-20 savings is not meaningful. Aim for 5-10% savings where the data supports it. You can suggest reducing by 2-3 units on high-volume items if days-of-stock after delivery is well above 10. Never go below 7 days of stock post-delivery.\n\n' +
